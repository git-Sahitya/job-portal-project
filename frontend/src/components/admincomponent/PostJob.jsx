    ...
    <div>
      ...
      <div className="flex items-center justify-center w-screen my-5">
        <form
          ...
          className="p-8 max-w-4xl border border-gray-500 shadow-sm hover:shadow-xl
        ...
        >
          ...
          <div className="flex items-center justify-center mt-5">
            {loading ? (
              ...
              <Button
                type="submit"
                className="w-full px-4 py-2 text-sm text-white bg-green-500 rounded-md hover:bg-green-700"
              >
                Post Job
              </Button>
            )}
